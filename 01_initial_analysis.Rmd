...
df_r1_hh %>% 
  ...
  # Selecting relevant variables
   select(hh_id, hh_split_r2_r3,hh_split_r3,hh_split_r2,hh_split_btwn_r2_r3,affected_upazila,hh_size,hh_head_religion,hh_ethnic_group) %>% 
  left_join(
    df_r1_anthr1 %>% 
...
mutate(
  ...
  select(-c(hh_id)) %>% 
    ...
    type = list(
      ...
      mean_speed ~ "continuous" ,
      mean_time ~ "continuous" ,
...
df_reg = df_r1_hh %>% 
                   mutate(hh_split_r2_r3 = ifelse(hh_split_r3=="1"|hh_split_r2=="1","1","0")) %>% 
  # Selecting relevant variables
   select(hh_id, hh_split_r2_r3,hh_size,affected_upazila,hh_head_religion,hh_ethnic_group, mean_speed, mean_time) %>% 
  left_join(
    df_r1_anthr1 %>% 
      filter(relation_hhh=="primary respondent") %>% 
...
re4 <- felm(hh_split_r2_r3 ~ mean_time + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re5 <- felm(hh_split_r2_r3 ~ mean_speed + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)
...
df_reg = df_r1_hh %>% 
  ...
  # Selecting relevant variables
   select(hh_id, hh_split_btwn_r2_r3,hh_size,affected_upazila,hh_head_religion,hh_ethnic_group, mean_speed, mean_time) %>% 
  left_join(
    df_r1_anthr1 %>% 
      filter(relation_hhh=="primary respondent") %>% 
      select(hh_id, hhm_sex, hhm_age, marital_status_hhm, literacy_hhm, education_high, hhm_status, nbr_female, nbr_underfive, nbr_yngchldrn_5_10, nbr_teenager_10_20, nbr_adults_20_65, nbr_female_underfive, nbr_female_yngchldrn_5_10, nbr_female_teenager_10_20, nbr_female_adults_20_65, high_exposed,exposed_at_least_zero)) %>% 
...
re1 <- felm(hh_split_btwn_r2_r3 ~ affected_upazila + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re2 <- felm(hh_split_btwn_r2_r3 ~ exposed_at_least_zero + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re3 <- felm(hh_split_btwn_r2_r3 ~ high_exposed + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re4 <- felm(hh_split_btwn_r2_r3 ~ mean_time + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re5 <- felm(hh_split_btwn_r2_r3 ~ mean_speed + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)
...
mutate(affected_upazila = factor(affected_upazila, levels = c("0", "1")),
       attrition = factor(attrition, levels = c("0", "1"), labels = c("Hh. doesn't attrited", "Hh. attrited"), ordered = TRUE)) %>%
  left_join(
    df_r1_anthr1 %>% 
      filter(relation_hhh=="primary respondent") %>% 
      select(hh_id,  mean_speed, mean_time, hhm_sex, hhm_age, marital_status_hhm, literacy_hhm, education_high, hhm_status, nbr_female, nbr_underfive, nbr_yngchldrn_5_10, nbr_teenager_10_20, nbr_adults_20_65, nbr_female_underfive, nbr_female_yngchldrn_5_10, nbr_female_teenager_10_20, nbr_female_adults_20_65)) %>% 
mutate(
         mean_speed = as.numeric(mean_speed),
         mean_time = as.numeric(mean_time),
         nbr_female = as.numeric(nbr_female),
...
df_reg = df_r1_hh %>% 
  ...
  left_join(
    df_r1_anthr1 %>% 
      filter(relation_hhh=="primary respondent") %>% 
      select(mean_speed, mean_time, hh_id, hhm_sex, hhm_age, marital_status_hhm, literacy_hhm, education_high, hhm_status, nbr_female, nbr_underfive, nbr_yngchldrn_5_10, nbr_teenager_10_20, nbr_adults_20_65, nbr_female_underfive, nbr_female_yngchldrn_5_10, nbr_female_teenager_10_20, nbr_female_adults_20_65, high_exposed, exposed_at_least_zero)) %>% 
mutate(
  high_exposed = factor(high_exposed, levels = c("0", "1")),
  exposed_at_least_zero = factor(exposed_at_least_zero, levels = c("0", "1")),
  affected_upazila = factor(affected_upazila, levels = c("0", "1")),
...
re1 <- felm(attrition ~ affected_upazila + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re2 <- felm(attrition ~ exposed_at_least_zero + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re3 <- felm(attrition ~ high_exposed + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re4 <- felm(attrition ~ mean_time + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)

re5 <- felm(attrition ~ mean_speed + hhm_sex + hhm_age+ hh_size +  marital_status_hhm+ literacy_hhm+ education_high +  hh_head_religion + hh_ethnic_group + nbr_female+ nbr_underfive+ nbr_yngchldrn_5_10+ nbr_teenager_10_20+ nbr_adults_20_65+ nbr_female_underfive+ nbr_female_yngchldrn_5_10+ nbr_female_teenager_10_20+ nbr_female_adults_20_65, data=df_reg)
