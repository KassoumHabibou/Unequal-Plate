...
df_r1_hh %>% 
  ...
  # Selecting relevant variables
   select(hh_id, hh_split_r2_r3,hh_split_r3,hh_split_r2,hh_size,affected_upazila,hh_head_religion,hh_ethnic_group) %>% 
  left_join(
    df_r1_anthr1 %>% 
  ...
  select(-c(hh_id)) %>% 
    ...
    by = hh_split_r2_r3, 
     label = list(
       ...
       hh_split_r3 ~ "Split btwn R2 and R3",
...
stargazer(re0, re1, re2, re3, re4, re5, type = "text", title = "Splitted hh. characteristics", digits=2, float = TRUE, se.position = "below", omit.stat=c("LL","ser","f","adj.rsq","res.dev"), dep.var.labels.include = TRUE,font.size="small",
