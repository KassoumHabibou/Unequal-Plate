...
#### Link between splitted at least one and hh. characteristics at baseline (using Komen)
```{r, results='hold', include = TRUE, warning=FALSE, echo = FALSE}
...
#### Link between splitted after the cyclone and hh. characteristics at baseline (Komen)
...
# PanelView graph
panelView::panelview(1 ~ treat_group_komen + hh_size, gridOff = TRUE, by.timing = TRUE,
