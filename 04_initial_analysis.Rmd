...
tbl_data %>% 
    ggplot(aes(x = year, y = depvar, color = affected_komen)) +
    ...
    ggsave("output/img/stat desc/outcome_mean.pdf", width = 18, height = 7, units = "cm")
...
tbl_data %>% 
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex.pdf", width = 18, height = 7, units = "cm")
