...
panelView::panelview(1 ~ treat_group + weight_kg + height_cm, gridOff = TRUE, by.timing = TRUE, data = all_comb, index = c("member_id","survey_year"), display.all = TRUE,
...
df_global_corrected %>% 
  group_by(year,affected_komen) %>% 
    ...
    mutate(affected_komen = factor(affected_komen, levels = c("0", "1"), labels = c("No affected", "Affected"), ordered = TRUE)) %>% 
    pivot_longer(cols = mean_haz:mean_bmiz, names_to = "outcome",values_to = "depvar") %>% pivot_longer(cols = lower_haz:lower_bmiz, names_to = "lower",values_to = "CI2.5") %>%  pivot_longer(cols = upper_haz:upper_bmiz, names_to = "upper",values_to = "CI97.5") %>% 
  ...
  geom_linerange(aes(ymin = CI2.5, ymax = CI97.5), lwd = 0.3) +
    ...
    ggsave("output/img/stat desc/outcome_mean_affected_komen.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  ungroup() %>% 
  mutate(exposed_at_least_zero_komen = factor(exposed_at_least_zero_komen, levels = c("0", "1"), labels = c("No affected", "Affected"), ordered = TRUE)) %>% 
  pivot_longer(cols = mean_haz:mean_bmiz, names_to = "name",values_to = "depvar") %>% 
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = exposed_at_least_zero_komen)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2015, linetype="longdash", color="red") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
    ggsave("output/img/stat desc/outcome_mean_exposed_at_least_komen.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = high_exposed_komen)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2015, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
    ggsave("output/img/stat desc/outcome_mean_high_exposed_komen.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = affected_komen, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2015, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_affected_komen.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = exposed_at_least_zero_komen, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2015, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_exposed_at_least_komen.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = high_exposed_komen, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2015, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_high_exposed_komen.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = affected_roanu)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
    ggsave("output/img/stat desc/outcome_mean_affected_roanu.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = exposed_at_least_zero_roanu)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2016, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
    ggsave("output/img/stat desc/outcome_mean_exposed_at_least_roanu.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = high_exposed_roanu)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2016, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
    ggsave("output/img/stat desc/outcome_mean_high_exposed_roanu.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = affected_roanu, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2016, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_affected_roanu.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = exposed_at_least_zero_roanu, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2016, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_exposed_at_least_roanu.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = high_exposed_roanu, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2016, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_high_exposed_roanu.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
    ...
    summarise(mean_haz = mean(haz_who, na.rm=T),
              ...
              upper_haz = mean(haz_who, na.rm=T) + qt(1- 0.05/2, (n() - 1))*sd(haz_who, na.rm=T)/sqrt(n()),
              lower_waz = mean(waz_who, na.rm=T) - qt(1- 0.05/2, (n() - 1))*sd(waz_who, na.rm=T)/sqrt(n()),
              upper_waz = mean(waz_who, na.rm=T) + qt(1- 0.05/2, (n() - 1))*sd(waz_who, na.rm=T)/sqrt(n()), lower_bmiz = mean(bmiz_who, na.rm=T) - qt(1- 0.05/2, (n() - 1))*sd(bmiz_who, na.rm=T)/sqrt(n()),
              upper_bmiz = mean(bmiz_who, na.rm=T) + qt(1- 0.05/2, (n() - 1))*sd(bmiz_who, na.rm=T)/sqrt(n())) %>% 
  mutate(high_exposed_mora = factor(high_exposed_mora, levels = c("0", "1"), labels = c("No affected", "Affected"), ordered = TRUE)) %>% 
  pivot_longer(cols = mean_haz:mean_bmiz, names_to = "name",values_to = "depvar") %>% 
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = affected_mora)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
    ggsave("output/img/stat desc/outcome_mean_affected_mora.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = exposed_at_least_zero_mora)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2017, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
    ggsave("output/img/stat desc/outcome_mean_exposed_at_least_mora.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = high_exposed_mora)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2017, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
    ggsave("output/img/stat desc/outcome_mean_high_exposed_mora.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = affected_mora, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2017, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_affected_mora.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = exposed_at_least_zero_mora, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2017, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_exposed_at_least_mora.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
  ...
  mutate(name = recode(name, "mean_haz" = "HAZ" ,
                             "mean_waz" = "WAZ",
                             "mean_bmiz" = "BMIZ")) %>% 
    ggplot(aes(x = year, y = depvar, color = high_exposed_mora, linetype=hhm_sex)) +
    geom_line(linewidth=0.5)+
    geom_point(size=0.7) +
    geom_vline(xintercept = 2017, linetype="longdash", color="red") +
    facet_wrap(vars(name), scales = "free_x") +
    ...
    theme_light(base_size = 8)+
    theme(legend.position = 'bottom',text = element_text(size=8), legend.direction = "horizontal")
      ggsave("output/img/stat desc/outcome_mean_bysex_high_exposed_mora.pdf", width = 18, height = 7, units = "cm")
...
df_global_corrected %>% 
    ...
    summarise(mean_haz = mean(haz_who, na.rm=T),
              mean_waz = mean(waz_who, na.rm=T),
              mean_bmiz = mean(bmiz_who, na.rm=T)) %>% 
    mutate(high_exposed_mora = factor(high_exposed_mora, levels = c("0", "1"), labels = c("No affected", "Affected"), ordered = TRUE)) %>% pivot_wider(names_from = hhm_sex, values_from = mean_haz:mean_bmiz)
```
